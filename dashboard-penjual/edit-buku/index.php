...
// $sql = "SELECT buku.*, menginput.tanggal_input FROM buku LEFT JOIN menginput ON buku.id_buku = menginput.id_buku UNION SELECT buku.*, menginput.tanggal_input FROM buku RIGHT JOIN menginput ON buku.id_buku = menginput.id_buku;";
$sql = "SELECT buku.*, menginput.tanggal_input FROM buku JOIN menginput ON buku.id_buku = menginput.id_buku;";
// $sql = "SELECT buku.*, menginput.*, transaksi.* FROM buku JOIN menginput ON buku.id_buku = menginput.id_buku JOIN transaksi ON buku.id_buku = transaksi.id_buku;";
		...
		<nav id="sidebar">
			...
			<div class="p-4 pt-5">
				...
				<ul class="list-unstyled components mb-5">
					...
					<li>
						<a class="text-decoration-none" href="#">Edit Produk</a>
					</li>
					<li>
		...
		<div id="content" class="m-4 m-md-5 mt-5">
			...
			<table class="table table-striped table-hover table-light">
                ...
                <?php while ($data = mysqli_fetch_array($query)): ?>
					...
					<td  style="text-align: center; vertical-align: middle;"><img style="width: 70px;" src="../../<?php echo $data['cover_buku']; ?>" alt=""> </td>
                    <?php
					echo "<td>";
                    echo "<a href='edit.php?id=".$data['id_buku']."'>Edit</a> | ";
                    echo "<a href='delete.php?id=".$data['id_buku']."'>Hapus</a>";
                    echo "</td>";
                    ?>
				    </tr>
                <?php endwhile; ?>
