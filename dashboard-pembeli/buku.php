                ...
                <div class="card mt-4">
                    <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-text">Rp. <?php echo number_format($buku['harga_buku'], 0, ',', '.'); ?></h4>
                        </div>
                        <div class="btn btn-lg">
                        <a href="checkout.php?page=<?php echo $buku['id_buku']?>" class="btn btn-primary px-5" type="button">Beli</a>
                        </div>
                        </div>
                    </div>
                </div>
